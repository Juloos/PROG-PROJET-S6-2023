...
public class Config {
    ...
    public final static double ANIMATION_DURATION = 2.0;
...
//    public final static String[] COULEURS = {"", "0*", "1*", "2*", "3*"};
    ...
    public final static Heuristique IA_DIFFICILE_HEURISTIQUE = new H3(10, IA.Difficulte.ALEATOIRE);
    public final static int IA_DIFFICILE_PROFONDEUR = 1;
    public final static double IA_DIFFICILE_THRESHOLD = 1000;
}
